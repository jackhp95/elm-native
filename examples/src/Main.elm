...
view model =
    ...
    , body =
            ...
            , ul []
                ...
                , li []
                    [ a
                        ...
                        [ img [ class "h-[1em]", src "https://api.iconify.design/mdi:github.svg", alt "Github" ] []
                        ]
                    ]
                ]
            ]
        , main_
            ...
            [ aside []
                [ nav
                    [ class "closed-on-mobile"
                    ]
                    [ a
                        [ href "./"
                        , class "secondary"
                        , id "toggle-docs-navigation"
                        ]
                ...
                [ section [ id "forms" ]
                    [ node "hgroup"
                        ...
                        [ h1 []
                            [ text "Forms" ]
                        , h2 []
                            [ text "All form events are fully responsive in pure semantic HTML, allowing forms to scale gracefully across devices and viewports." ]
                        ]
                    , p []
                        [ text "Inputs are"
                        , code []
                    ...
                    , article
                        [ attribute "aria-label" "Validation states examples"
                        ]
                        [ Html.form
                            [ class "grid"
                            ]
                    ...
                    , p []
                        ...
                        , text "is unstyled and acts as a container for radios and checkboxes, providing a consistent"
                        , code []
                            [ i []
                                [ text "margin-bottom" ]
                            ]
                    ...
                    , p []
                        [ text "enable a custom switch."
                        ]
                    , article
                        [ attribute "aria-label" "Select, radios, checkboxes, switch examples"
                        ]
                        [ label
                            [ for "fruit"
                            ]
                    ...
                    , p []
                        [ text "You can change a checkbox to an indeterminate state by setting the"
                        , code []
                            [ i []
                                [ text "indeterminate" ]
                            ]
                    ...
                    , article
                        [ attribute "aria-label" "Indeterminate checkbox example"
                        ]
                        [ label
                    ...
                    , p []
                        [ text "Others input types:" ]
                    , article
                        [ attribute "aria-label" "Search, file browser, range slider, date, time, color examples"
                        ]
                        [ input
                            [ type_ "search"
                            , id "search"
